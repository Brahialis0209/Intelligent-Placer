...
### Что поменялось в финальной версии?
1. Убраны лишние вызовы трудовычислимых по времени функций.
2. Оптимизирован алгоритм перемещения контура объекта а также сократилось количество вызовов этой функции.
3. Улучшен шаг алгоритма, при котором выбиралась рандомная позиция для первого контура максимального по площади предмета. Теперь он (предмет) ставится как можно ближе к краю многоугольника.
